 ...
 */
final class Version20200114105458 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE music (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, album_id INTEGER DEFAULT NULL, label_id INTEGER DEFAULT NULL, duration INTEGER NOT NULL)');
